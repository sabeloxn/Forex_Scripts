...
namespace cAlgo.Indicators
{
    ...
    public class CleanChartv111 : Indicator
    {
        ...
        [Output("Short Main",LineColor = "#FFFFFF66",PlotType =PlotType.Points, Thickness = 5)]
        public IndicatorDataSeries ShortResult{get;set;}
        [Output("Long Main",LineColor = "#FFFFC306",PlotType =PlotType.Points, Thickness = 5)]
