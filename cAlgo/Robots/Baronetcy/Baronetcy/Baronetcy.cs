...
//------------------------------------------------------------------------------------------------------------------------------------        
        ...
        protected override void OnBar()
        {
            ...
            LotSize = (long)Math.Ceiling(Account.Balance / 1000) * 100;
            ...
            longPreviousClose = Bars.ClosePrices.LastValue;
            //+ longBuffer;
            shortPreviousClose = Bars.ClosePrices.LastValue;
            //- shortBuffer;
            stflongPreviousClose = Bars.ClosePrices.LastValue;
            //+ stflongBuffer;
            stfshortPreviousClose = Bars.ClosePrices.LastValue;
            // - stfshortBuffer;
            ...
            var previousClose = (Bars.ClosePrices.LastValue) + 0.2;
            var stfpreviousClose = (stfSeries.ClosePrices.LastValue) + 0.2;
...
//---------------------------------------------------------------------HIGHS AND LOWS----------------------------------------------
            ...
            Chart.DrawTrendLine("high " + today, today, high, tomorrow, high, Color.Blue);
            Chart.DrawTrendLine("low " + today, today, low, tomorrow, low, Color.DarkSeaGreen);
